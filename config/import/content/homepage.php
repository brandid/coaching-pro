...
<h2 class="has-theme-color-4-color has-text-color"><strong>How it all works</strong></h2>
<!-- /wp:heading -->
...
<p class="has-white-color has-text-color">Outline your philosophy, method, training plan, or course so it’s inviting and inspiring.</p>
<!-- /wp:paragraph -->
...
<h4 class="has-text-align-center has-white-color has-text-color"><strong>Take the leap</strong></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"white"} -->
<p class="has-text-align-center has-white-color has-text-color">Start with your call to action, whether it relates to getting healthier, working strategically or living better.</p>
...
<!-- wp:heading {"textAlign":"center","level":4,"textColor":"white"} -->
<h4 class="has-text-align-center has-white-color has-text-color"><strong>Learn every day</strong></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"white"} -->
<p class="has-text-align-center has-white-color has-text-color">Let potential clients know what happens next, after they’ve made the decision to work with you.</p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:genesis-blocks/gb-column -->
...
<!-- wp:heading {"textAlign":"center","level":4,"textColor":"white"} -->
<h4 class="has-text-align-center has-white-color has-text-color"><strong>Enjoy life</strong></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"white"} -->
<p class="has-text-align-center has-white-color has-text-color">Show viewers the happy outcome and bright future you’ll help them build for themselves.</p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:genesis-blocks/gb-column --></div></div>
<!-- /wp:genesis-blocks/gb-columns --></div></div>
<!-- /wp:genesis-blocks/gb-column --></div></div>
