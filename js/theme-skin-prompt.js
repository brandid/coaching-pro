	...
	for (var i = 0; i < starterPacks.length; i++) {
		...
		button.addEventListener( 'click', function( e ) {
			...
			Swal.fire({
				...
				icon: 'question',
				html: '<div style="text-align: left; display: flex; flex-wrap: wrap;"><p class="description" style="text-align: center;">When installing a new starter-pack/skin, it is highly recommended to overwrite the skin\'s previous settings.</p><label for="coaching-pro-customizer-option" style="display: block; width: 100%; margin-top: 15px;margin-bottom: 10px;"><input type="checkbox" id="coaching-pro-customizer-option" value="customizer_true" checked="checked" />Overwrite Customizer Settings (Recommended)</label><label style="display: block; width: 100%;" for="coaching-pro-posts-option"><input type="checkbox" id="coaching-pro-posts-option" value="posts_true" checked="checked" />Remove and Install Theme Content (Recommended)</label>',
				preConfirm: function() {
