...
function coachingpro_register_block_patterns() {
	...
	if ( class_exists( 'WP_Block_Patterns_Registry' ) ) {
		...
		ob_start();
		?>
		<!-- wp:genesis-blocks/gb-columns {"backgroundImgURL":"https://coachingpro.local/wp-content/themes/coaching-pro/images/sample-hero.jpg","columns":1,"layout":"one-column","align":"full","marginBottom":60,"paddingTop":200,"paddingRight":30,"paddingBottom":200,"paddingLeft":30,"textColor":"white","backgroundColor":"colorone","columnMaxWidth":600} -->
<div class="wp-block-genesis-blocks-gb-columns gb-layout-columns-1 one-column gb-background-cover gb-background-no-repeat has-colorone-background-color has-white-color gb-columns-center alignfull" style="margin-bottom:60px;padding-top:200px;padding-right:30px;padding-bottom:200px;padding-left:30px;background-image:url(<?php echo esc_url( $sample_hero_image ); ?>)"><div class="gb-layout-column-wrap gb-block-layout-column-gap-2 gb-is-responsive-column" style="max-width:600px"><!-- wp:genesis-blocks/gb-column {"textAlign":"center"} -->
<div class="wp-block-genesis-blocks-gb-column gb-block-layout-column"><div class="gb-block-layout-column-inner" style="text-align:center"><!-- wp:heading {"level":1,"textColor":"white"} -->
<h1 class="has-white-color has-text-color"><strong>Coaching just got better.</strong></h1>
<!-- /wp:heading -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-theme-color-4-color has-white-background-color has-text-color has-background" href="#">Buy Now</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:genesis-blocks/gb-column --></div></div>
<!-- /wp:genesis-blocks/gb-columns -->
<?php
		$mainhero_pattern_content = ob_get_clean();
		...
		ob_start();
		?>
		<!-- wp:genesis-blocks/gb-columns {"columns":2,"layout":"gb-2-col-equal","columnsGap":0,"align":"full","backgroundColor":"bgcolorone"} -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( $sample_hero_image ); ?>" alt="" class="wp-image-9999"/></figure>
<!-- /wp:image --></div></div>
<!-- /wp:genesis-blocks/gb-column -->

<!-- wp:genesis-blocks/gb-column {"textAlign":"center","paddingSync":true,"padding":40,"columnVerticalAlignment":"center"} -->
<div class="wp-block-genesis-blocks-gb-column gb-block-layout-column gb-is-vertically-aligned-center"><div class="gb-block-layout-column-inner" style="padding:40px;text-align:center"><!-- wp:heading {"level":1,"textColor":"black"} -->
<h1 class="has-black-color has-text-color"><strong>Coaching just got better.</strong></h1>
<!-- /wp:heading -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-white-color has-theme-color-4-background-color has-text-color has-background" href="#">Buy Now</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:genesis-blocks/gb-column --></div></div>
<!-- /wp:genesis-blocks/gb-columns -->
		<?php
		$hero2columns_pattern_content = ob_get_clean();
		...
		ob_start();
		?>
		<!-- wp:genesis-blocks/gb-columns {"columns":2,"layout":"gb-2-col-equal","columnsGap":0,"align":"full"} -->
...
<!-- /wp:genesis-blocks/gb-columns -->
		<?php
		$basic2columns_pattern_content = ob_get_clean();
